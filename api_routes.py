...
from auth import hash_password, verify_password, create_access_token, get_current_user_from_request
...
async def export_full_show(show_id: int, request: Request):
    ...
    from models import ShowAction, LLMInteraction
    import json
