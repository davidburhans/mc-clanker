...
VALID_SUB_FAMILIES: List[str] = [
    ...
    "Pan Flute",
    # Infinite Pianos
    "Soft E. Piano", "Medium E. Piano",
    # Vocal Textures
    "Male Vocal Texture", "Female Vocal Texture", "Ensemble Vocal Texture",
]
                        ...
                        "items": {
                            "anyOf": [
                                ...
                                },
                                {
                                    ...
                                    "required": [
                                        "action_type", "model_id", "major_family",
                                        "sub_family", "timbre_tags", "notation_tag", "fx_tag", "bars"
                                    ],
                                    "additionalProperties": False
                                },
                                {
